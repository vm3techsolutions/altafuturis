...
import { EnvelopeIcon, PhoneIcon, ChevronDoubleRightIcon  } from "@heroicons/react/24/solid";

const Menu = () => {
  return (
    <>
      {/* Top Bar */}
      <div className="text-gray-900 p-2 bg-gradient-to-r from-[#D4B3010D] via-[#0D6EFD1A] to-[#D4B3010D] backdrop-blur-md sticky top-0 z-50">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex space-x-6 items-center">
            ...
            <button className="flex items-center space-x-4 bg-blueColor text-white px-2 py-2 rounded-xl text-sm hover:bg-yellow-400">
      ...
      {/* Menu Bar */}
      <nav className="bg-white sticky top-[42px] z-40 shadow-md">
        <div className="container mx-auto p-4 flex justify-center">
          <ul className="menu flex space-x-2 text-sm  font-bold-md uppercase">
            <li>
