      ...
      <section className="container min-h-screen flex items-center justify-center py-16">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between w-full space-y-8 md:space-y-0">
          ...
          <div className="flex-shrink-0 md:mr-12">
            <button className="md:ml-44 md:mb-44 px-3 py-1 border-2 border-brownColor rounded-full text-black  shadow-sm hover:bg-brownColor transition-all duration-300 ease-in-out font-bold">
              Who we are
            </button>
          </div>
          ...
          <div className="max-w-3xl text-center md:text-left">
            ...
            <a href="/" className="flex justify-start mr-11 md:mr-16">
