...
const QuoteSection = () => {
  return (
    <div className="flex flex-col lg:flex-row items-center justify-between bg-[#6328A6] text-white p-10 lg:p-20 gap-10">
      {/* Left Section */}
      ...
      {/* Right Section - Form */}
      <div className="bg-white text-black p-8 rounded-lg shadow-lg w-full lg:w-1/3">
