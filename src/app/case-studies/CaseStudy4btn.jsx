...
export default function CategoryButtons({ setFilteredBlogs }) {
  ...
  return (
    <div className="flex flex-wrap items-center justify-center space-x-4 gap-y-4 py-10">
      <button
        className="bg-blue-600 text-white px-4 py-2 rounded-lg font-semibold hover:bg-blue-700 sm:w-auto w-full"
      ...
      {categories.map((category) => (
        <button
          ...
          className="border border-yellow-500 text-black px-4 py-2 rounded-lg font-semibold hover:bg-yellow-100 sm:w-auto w-full"
