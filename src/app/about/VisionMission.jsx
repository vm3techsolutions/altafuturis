...
const VisionMission = () => {
  ...
  return (
    <>
      <section className="flex items-center justify-center lg:py-16 md:py-8 py-4">
        <div className="container flex items-center justify-center">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-start w-full space-y-8 md:space-y-0">
            {/* Left Column */}
            <div className="max-w-4xl flex-shrink-0  md:mr-12">
              <div className=" relative w-[14vw] h-[20vh] mr-36 flex flex-col justify-center text-center  p-4 bg-white rounded-lg">
                <button
            ...
            <p className="-mt-12"><span className="text-8xl text-gray-900 font-bold mr-4 ">“</span></p>
            {activeTab == "vision" && 
              <p className="text-lg">
              ...
              {activeTab == "mission" && 
              <p className="text-lg">To empower businesses worldwide by integrating cutting-edge technologies, automating processes, and delivering innovative solutions in Artificial Intelligence, Data Engineering, and Salesforce, thereby driving efficiency and growth. </p>
              }
              <p className="-mb-32"><span className="text-8xl text-gray-900 font-bold ">”</span></p>
            </div>
          </div>
        </div>
      </section>
