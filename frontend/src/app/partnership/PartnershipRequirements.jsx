  ...
  return (
    <div className="flex flex-col md:flex-row lg:flex-row items-center justify-between bg-[#6328A6] text-white p-10 lg:p-20 gap-10">
      ...
      <div className="md:w-full w-full flex justify-center  md:justify-start mb-16 md:mb-0 ">
        ...
        <a href="/contact" className="flex justify-center lg:justify-start md:justify-start mt-6 mr-1 md:mr-16">
      ...
      {/* Right Section - Form */}
      <div className="bg-white text-black p-8 rounded-lg shadow-lg w-[80vw] lg:w-1/3 md:w-1/2">
