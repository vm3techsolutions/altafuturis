...
export default function PrivacyPolicy() {
  return (
    <>
    <div className="mt-24 md:mt-36 px-6 md:px-24 py-6 ">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Altafuturis, 301, Anish, LMD Square,
            Bavdhan, Pune, Maharashtra 411023 INDIA.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Alta Futuris, accessible from{" "}
            <a
              href="https://altafuturis.com/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://altafuturis.com/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: sales@altafuturis.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href="https://altafuturis.com/contact"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://altafuturis.com/contact
            </a>
          </p>
        </li>
        <li>
          <p>By phone number: +91 97646 94844</p>
        </li>
      </ul>
      </div>
    </>
